...
public class RepeticionAnualTest {
    ...
    public void RepeticionConOcurrencias() {
        ...
        for (int i = 1; i < ocurrencias; i++) {
            ...
            fechaInicio = fechaInicio.plusYears(repeticionOcurrencias.getIntervalo());
            fechaFin = fechaFin.plusYears(repeticionOcurrencias.getIntervalo());
    ...
    public void RepeticionConFecha() {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            fechaFin = fechaFin.plusYears(repeticion.getIntervalo());
    ...
    public void RepeticionInfinita() {
        ...
        //Arrange
        var repeticion = new RepeticionAnual(1,  0);
