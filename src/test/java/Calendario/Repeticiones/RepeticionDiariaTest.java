...
public class RepeticionDiariaTest {
    ...
    public void RepeticionConOcurrencias() {
        ...
        //Arrange
        int ocurrencias = 15;
        var repeticionOcurrencias = new RepeticionDiaria(2,null, ocurrencias);
        ...
        for (int i = 1; i < ocurrencias; i++) {
            ...
            fechaInicio = fechaInicio.plusDays(repeticionOcurrencias.getIntervalo());
            fechaFin = fechaFin.plusDays(repeticionOcurrencias.getIntervalo());
    ...
    public void RepeticionConFecha() {
        ...
        //Arrange
        var fechaHasta = LocalDate.of(2023, 5, 16);
        var repeticion = new RepeticionDiaria(1, fechaHasta, 0);
        ...
        for (int i = 0; i < 5; i++) {
            ...
            fechaInicio = fechaInicio.plusDays(repeticion.getIntervalo());
            fechaFin = fechaFin.plusDays(repeticion.getIntervalo());
    ...
    public void RepeticionInfinita() {
        ...
        //Arrange
        var repeticion = new RepeticionDiaria(1, null, 0);
